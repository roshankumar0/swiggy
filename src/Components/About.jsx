    ...
    return <>
        <div className='flex justify-center items-center py-20 bg-white'>
            <div className='h-[460px]  rounded-[45px] w-[800px]  flex justify-center items-center gap-5 flex-col'>
                <h2 className='box-border text-[rgba(2,6,12,0.75)] text-[40px] leading-[49.92px] max-w-[95%] shrink-0 font-black tracking-[0.03px] uppercase text-center mx-[10px] my-0'>IPO Delivered - November 2024</h2>
        ...
        <div className='bg-white'>
            <div className='px-[10px]'>
                <div className=' max-w-[1180px] m-auto flex flex-col justify-center gap-5 pt-[50px] pb-20'>
                    <h2 className='box-border text-[rgba(2,6,12,0.75)] text-[40px] leading-[49.92px] max-w-[95%] shrink-0 font-black tracking-[0.03px] uppercase text-center mx-[10px] my-0'>GET TO KNOW US</h2>
        ...
        <div className='bg-white'>
            <div className='px-[10px]'>
                <div className=' max-w-[1180px] m-auto flex flex-col justify-center gap-5 pt-[50px] pb-20'>
                    <h2 className='box-border text-[rgba(2,6,12,0.75)] text-[40px] leading-[49.92px] max-w-[95%] shrink-0 font-black tracking-[0.03px] uppercase text-center mx-[10px] my-0 '> INDUSTRY PIONEER</h2>
                    <div className='flex gap-[56px] items-center'>
                        <div className='text-[#02060C99]  text-[18px] font-Gilroy font-medium leading-6 tracking-[-0.03px] flex-1'>
                            <p className='box-border text-[rgba(2,6,12,0.6)] h-[144px] text-[18px] font-medium tracking-[-0.03px] leading-[24px] text-start'>Being among the first few entrants, Swiggy has successfully pioneered the hyperlocal commerce industry in India, launching Food Delivery in 2014 and Quick Commerce in 2020. Due to the pioneering status of Swiggy, it is well-recognised as a leader in innovation in hyperlocal commerce and as a brand synonymous with the categories it is present in.
                            </p>
                        </div>
                        <div className='px-[66px] py-9 flex-1 border-2 rounded-[45px] box-border text-[rgb(51,51,51)] overflow-hidden h-[357.65px] text-center text-[16px] font-normal leading-[24px]'>
                            <img className='className="box-border h-[285.65px] max-w-full text-[rgb(51,51,51)] break-inside-auto transition-[0.2s] inline-block align-middle text-center text-[16px] font-normal leading-[24px] rounded-none"' src="https://www.swiggy.com/corporate/wp-content/uploads/2024/11/Group-1116602947-768x507.webp" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='px-[10px]'>
                <div className=' max-w-[1180px] m-auto flex flex-col justify-center gap-5 pt-[50px] pb-20'>
                    <div className='flex justify-between'>
                        <div>
                            <span className='box-border text-[rgb(27,166,114)] grow  whitespace-pre-wrap text-[36px] font-extrabold leading-[40px] tracking-[-0.8px]'>3 Billion+</span>
                            <p className='box-border text-[rgb(84,89,95)]  flex flex-1 text-[18px] font-medium leading-[24px] tracking-[-0.3px] '>orders delivered</p>
                        </div>
                        <div>
                            <span className='box-border text-[rgb(27,166,114)] grow  whitespace-pre-wrap text-[36px] font-extrabold leading-[40px] tracking-[-0.8px]'>220k+</span>
                            <p className='box-border text-[rgb(84,89,95)]  flex flex-1 text-[18px] font-medium leading-[24px] tracking-[-0.3px] '>restaurant partners</p>
                        </div>
                        <div>
                            <span className='box-border text-[rgb(27,166,114)] grow  whitespace-pre-wrap text-[36px] font-extrabold leading-[40px] tracking-[-0.8px]'>520k+</span>
                            <p className='box-border text-[rgb(84,89,95)]  flex flex-1 text-[18px] font-medium leading-[24px] tracking-[-0.3px] '>delivery partners</p>
                        </div>
                        <div>
                            <span className='box-border text-[rgb(27,166,114)] grow  whitespace-pre-wrap text-[36px] font-extrabold leading-[40px] tracking-[-0.8px]'>680k+</span>
                            <p className='box-border text-[rgb(84,89,95)]  flex flex-1 text-[18px] font-medium leading-[24px] tracking-[-0.3px] '>cities in India</p>
                        </div>
                    </div>
                </div>
            </div>
