            ...
            <div className='flex overflow-scroll gap-7'>
                <div className=" text-[rgb(51,51,51)] relative self-auto flex-[1_0_auto] order-none items-center gap-[72px] h-[297.55px] min-h-[auto] min-w-0 overflow-visible w-[739.5px] z-auto text-start flex text-[16px] font-normal leading-[24px] rounded-[40px] border-[0.8px] border-solid border-[rgb(84,100,120)]" >
                    <span>
                        ...
                        >
                            <path
                                d="M16.3816 3.09994C16.4479 2.6579 17.0852 2.6579 17.1515 3.09994C18.18 9.96427 23.5688 15.353 30.4332 16.3816C30.8752 16.4479 30.8752 17.0852 30.4332 17.1515C23.5688 18.18 18.18 23.5688 17.1515 30.4332C17.0852 30.8752 16.4479 30.8752 16.3816 30.4332C15.353 23.5688 9.96427 18.18 3.09994 17.1515C2.6579 17.0852 2.6579 16.4479 3.09994 16.3816C9.96427 15.353 15.353 9.96427 16.3816 3.09994Z"
                                fill="white"
                            />
                        </svg>
                    </span>
