...
const Search = () => {
    return (
        <div className='relative pt-16 pb-8'>
            ...
            <header>
                <h1 className='w-[60%] m-auto text-center pl-3 text-white text-[48px] font-bold leading-[-0.3px]'> Order food & groceries. Discover best restaurants. Swiggy it!</h1>
            </header>
            <div className='flex justify-center gap-4 mt-[24px]'>
                ...
                <div className=' pl-4 w-[500px] flex justify-between bg-white items-center rounded-[16px] px-[16px] gap-[10px] border-[1.5px] border-[#02060C26]'>
                    <span className='text-[18px] leading-[24px] tracking-[-0.3px] font-extralight text-[#02060c73]'>Search for restaurant, item or more</span>
                    <div>
                        <CiSearch size={24} />
                    </div>
                </div>
